 ...
 <body>
  ...
  <script>
   ...
   idS.onchange = async function(e) {
    ...
    qr.draw()
    document.querySelector('#instructions').innerHTML = \`<span lang="fi">Lue QR-koodi lompakkosovelluksellasi. Kun lompakkosi kysyy nelinumeroista koodia, syötä numerot <strong>\${otp}</strong></span><span lang="en">Scan the QR code using your digital wallet. When prompted for a code, insert <strong>\${otp}</strong></span>\`
    a.href = qrUrl
    o.textContent = ''
    o.appendChild(a)
